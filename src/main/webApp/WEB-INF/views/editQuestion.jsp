...
<form action="${pageContext.request.contextPath}/question/editQuestion/${question.questionId}" method="post">
  ...
  <input type="text" id="correctOption" name="correctOption" value="${question.correctOption}" required>
